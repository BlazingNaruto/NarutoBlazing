...
/*    if (element[2] && element[2].constructor != Array) element[2] = [ element[2], element[2], element[2] ];  */
    var result = {
		...
		maxSpeed : element[17], minAtk	: element [12] ,
        number: n
    };
...
utils.getThumbnailUrl = function(n) {
    ...
    return 'https://blazingnaruto.github.io/NarutoBlazing/common/Images/' + id + '.png';
};
...
utils.getThumbnailTitle = function(arg) {
    ...
    return [ unit.name, 'HP: ' + unit.maxHP, 'ATK: ' + unit.maxStrength, 'RCV: ' + unit.maxRCV, 'CMB: ' + unit.combo, 'Cost: ' + unit.cost ].join('\n');
};
