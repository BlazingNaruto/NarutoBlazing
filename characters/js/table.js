...
//            var temp = 0;
//            if (c == 'HP/ATK') temp = Math.round(x.maxHP / x.maxStrength * 100) / 100;
//           else if (c == 'HP/RCV') temp = Math.round(x.maxHP / x.maxRCV * 100) / 100;
//            else if (c == 'ATK/RCV') temp = Math.round(x.maxStrength / x.maxRCV * 100) / 100;
//            else if (c == 'ATK/CMB') temp = Math.round(x.maxStrength / x.combo * 100) / 100;
//            else if (c == 'ATK/cost') temp = Math.round(x.maxStrength / x.cost * 100) / 100;
